// Delivery Express Core Constants & Config - Balamban, Cebu Edition
export const BRAND = {
  ...
  coverage: "Balamban, Asturias, Toledo & Surrounding Cebu Municipalities",
  defaultCenter: {
    lat: 10.5015,
    lng: 123.7150,
...
export const SERVICES = [
  {
    id: "food_delivery",
    name: "Food Delivery",
    tagline: "Fast & hot from your favorite Balamban restaurant or food cart",
    icon: "Utensils",
    badge: "Popular",
    ...
    errandFee: 15,
    fields: [
      { name: "restaurantName", label: "Restaurant / Food Stall Name", type: "text", required: true, placeholder: "e.g. Jollibee Gaisano Balamban, Balamban Liempo, Kusina ni Nanay" },
  ...
  },
  {
    ...
    tagline: "Shop from convenience stores, bakery, or local Balamban stores",
    icon: "ShoppingBag",
    ...
    errandFee: 30,
    fields: [
      { name: "storeName", label: "Target Store / Convenience Shop", type: "text", required: true, placeholder: "e.g. 7-Eleven Balamban, Julie's Bakeshop, 360 Pharmacy" },
  ...
  },
  {
    ...
    errandFee: 35,
    fields: [
      { name: "billerName", label: "Biller / Payment Center", type: "text", required: true, placeholder: "e.g. CEBECO III, Balamban Water District, PLDT, Bayad Center" },
  ...
  },
  {
    ...
    errandFee: 25,
    fields: [
      { name: "taskTitle", label: "Task Overview", type: "text", required: true, placeholder: "e.g. Pick up laundry, Town Hall errand, Line queueing" },
  ...
  },
  {
    ...
    errandFee: 50,
    fields: [
      { name: "marketName", label: "Target Market / Supermarket", type: "text", required: true, placeholder: "e.g. Balamban Public Palengke, Gaisano Grand Supermarket" },
...
export const MOCK_RIDERS = [
  {
    id: "rider-1",
    name: "Kuya Junrey (Balamban Center)",
    phone: "0917-882-1923",
    plate: "7C-1234 (Honda Click 150i)",
    rating: 4.9,
    trips: 428,
    isOnline: true,
    isBusy: false,
  ...
  {
    id: "rider-2",
    name: "Kuya Marlon (Buanoy / Tsuneishi)",
    phone: "0928-441-9012",
  ...
  {
    id: "rider-3",
    name: "Kuya Jayson (Cantuod / Aliwan)",
    phone: "0939-112-7845",
