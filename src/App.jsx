...
function MainContent() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-zinc-950 text-zinc-100">
      ...
      <main className="flex-1 max-w-7xl w-full mx-auto p-4 sm:p-6 lg:p-8 space-y-6">
        ...
        {activeRole === 'customer' && (
          <div className="space-y-6">
            ...
            <div className="flex items-center justify-center sm:justify-start gap-2 border-b border-zinc-800 pb-3">
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all ${
                  customerTab === 'services'
                    ? 'bg-gradient-to-r from-rose-600 to-red-600 text-white shadow-lg shadow-rose-600/20'
              ...
              <button
                ...
                className={`flex items-center gap-2 px-5 py-2.5 rounded-2xl text-xs sm:text-sm font-bold transition-all relative ${
                  customerTab === 'tracker'
      ...
      {/* Footer */}
      <footer className="mt-auto border-t border-zinc-800/80 bg-zinc-950 py-8 px-4 text-xs text-zinc-400">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4 text-center md:text-left">
          
          <div className="flex items-center gap-2">
            <div className="w-8 h-8 rounded-xl bg-gradient-to-br from-rose-600 to-amber-500 flex items-center justify-center text-white font-bold">
              DE
            </div>
            <div>
              <p className="text-white font-bold">Delivery Express</p>
              <p className="text-zinc-500 text-[11px]">{BRAND.tagline}</p>
            </div>
          </div>
          ...
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <span>Operating Hours: <strong>{BRAND.operatingHours.display}</strong></span>
            <span>Coverage: <strong>{BRAND.coverage}</strong></span>
          </div>

          <p className="text-zinc-500 text-[11px]">
            &copy; {new Date().getFullYear()} Delivery Express. Ready for Vercel & Supabase.
          </p>
